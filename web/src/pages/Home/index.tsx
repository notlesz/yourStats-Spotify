    ...
    <div className="w-full min-h-screen">
      ...
      isFetchingTracks ? (
        ...
        <div className="max-w-[1350px] mx-auto my-0 flex flex-col justify-center gap-[30px]">
          <header className="px-6 flex justify-between items-center gap-4 py-20 animate-hideToShow sm:flex-col sm:gap-6">
            {user && (
              <>
                  ...
                  <div className="flex flex-col gap-1 items-start sm:items-center sm:gap-3">
                    ...
                    {!loadingButton ? (
                      <button
                        ...
                        className="bg-green-600 py-1 px-8 rounded text-neutral-100 font-bold"
                      >
                        Logout
                      </button>
                    ) : (
