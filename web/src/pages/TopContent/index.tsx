                ...
                {allTopArtists?.map((artists, index) => (
                  <Fragment key={artists.id}>
                    <div className='flex items-center justify-between gap-2'>
                      ...
                      <button
                        type='button'
                        className='font-bold flex items-center gap-2 text-base text-green-600 px-3 py-2 cursor-pointer hover:text-green-800 md:text-xs'
                        onClick={() => {
            ...
            {allTopTracks?.map((track, index) => (
              <Fragment key={track.id}>
                <div className='flex items-center justify-between gap-2'>
                  ...
                  <button
                    type='button'
                    className='font-bold flex items-center gap-2 text-base text-green-600 px-3 py-2 cursor-pointer hover:text-green-800 mb-2 md:text-xs'
                    onClick={() => {
                      window.open(track.external_urls.spotify, '__blank');
                    }}
                  >
                    <FaSpotify className='w-5 h-5' />
                    {!matches && 'Open in Spotify'}
